...
\end{align}
%
$\ddagger:$ Originally had this as $\left( (\bm{\delta}_{1}^{(t)})^{T} \bm{e}^{(t)} \right)^{T}$, but unnecessarily transposes two elements. Solution shown above is much cleaner. 
