...
\begin{align}
	\frac{\partial J}{\partial f_{3}} %
		&= \delta_{3} = \hat{\bm{y}} - \bm{y} \nonumber \\
	%
	\frac{\partial J}{\partial f_{2}} %
		&= \delta_{2} = \bm{W}_{2}\delta_{3} \circ \sigma'(f_{2}) \nonumber \\
	%
	\frac{\partial J}{\partial \bm{x}} %
		&= \frac{\partial J}{\partial f_{2}} \frac{\partial f_{2}}{\partial \bm{x}} \nonumber \\
	%
		&= \delta_{2} \frac{\partial f_{2}}{\partial \bm{x}} \nonumber \\
	%
		&= \delta_{2} \frac{\partial}{\partial \bm{x}} \bm{xW}_{1} + \bm{b}_{1} \nonumber \\
	% 
		&= \delta_{2} \bm{W}_{1} \nonumber
\end{align}
